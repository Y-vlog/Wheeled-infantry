...
#define PITCHM6020_POSITIONPID_POSITION_KP 10.0f//0.4f		//0.15f
#define PITCHM6020_POSITIONPID_POSITION_KI 0.0f//0.01f 	//0.0001f
#define PITCHM6020_POSITIONPID_POSITION_KD 0.0f//0.0f		//0.1f
#define PITCHM6020_SPEEDPID_POSITION_KP    8.0f//310.0f	//30.0f
#define PITCHM6020_SPEEDPID_POSITION_KI    0.0f//0.0f		//15.0f
#define PITCHM6020_SPEEDPID_POSITION_KD    0.01f//0.0f        //10.0f
