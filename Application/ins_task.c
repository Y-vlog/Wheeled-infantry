...
void INS_Task(void)
{
    ...
    if ((count % 1) == 0)
    {
        ...
        // 获取最终数据
        INS.Yaw = (int16_t) QEKF_INS.Yaw;                                             //QEKF_INS.Yaw(-360 到 360)
        INS.Pitch = (int16_t) QEKF_INS.Pitch;
        INS.Roll = (int16_t) QEKF_INS.Roll;
        INS.YawTotalAngle = (int16_t) QEKF_INS.YawTotalAngle;
